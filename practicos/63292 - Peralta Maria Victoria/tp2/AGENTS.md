...
- `edit.jsx` es el archivo de entrega en el que el alumno debe escribir su propia
  solución;
...
- implementes total o parcialmente `edit.jsx` o sus componentes auxiliares;
...
Podés ejecutar `edit.jsx`, inspeccionar su interfaz y explicar errores de compilación
