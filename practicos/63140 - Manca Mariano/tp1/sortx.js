...
try {
    ...
    // 3. Transformamos (Acordate que esta devolvía un arreglo con dos cosas: [header, lineas])
    ...
    // Si CUALQUIERA de las 6 funciones hace "throw new Error", el programa salta directamente acá.
    console.error(error.message);
    
    // Y acá cerramos el programa con un código "distinto de cero" (ej: 1), como pidió el profe:
    process.exit(1);
}
