...
Construí un módulo de importes que:

1. lea precio y cantidad desde strings;
2. almacene dinero en centavos seguros;
3. calcule subtotal, descuento e impuesto con una política de redondeo documentada;
4. presente el resultado con `Intl.NumberFormat`;
5. rechace valores vacíos, infinitos, negativos o fuera del rango seguro.

Después implementá una máscara de permisos y explicá por qué sus operaciones están limitadas a 32 bits cuando los valores son `number`.
