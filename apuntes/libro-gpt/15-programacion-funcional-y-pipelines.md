...
Implementá un reporte de alumnos como pipeline: validar, filtrar regulares, calcular promedio, ordenar por promedio y tomar los diez primeros. Escribí primero una versión con métodos de array, luego una con un solo bucle y finalmente una diferida con generadores. Medí con un conjunto grande y compará claridad, consumo y capacidad de cortar temprano.
