...
Construí un procesador de intentos de inicio de sesión. Debe permitir hasta tres intentos, ignorar entradas vacías sin consumir un intento, terminar con el comando `SALIR`, clasificar el resultado con `switch` y devolver un historial. Antes de programar, escribí estado inicial, condición de continuación, progreso y todos los estados de salida.
