...
Construí `normalizarNombreVisible(texto)` con este contrato:

1. elimina espacios exteriores;
2. colapsa espacios interiores repetidos;
3. normaliza a NFC;
4. exige entre 2 y 40 grafemas;
5. conserva el texto original para auditoría;
6. produce una clave de comparación independiente de mayúsculas, adecuada para español.

Probala con acentos compuestos y descompuestos, emoji, cadenas vacías y nombres que superen el límite en grafemas pero no necesariamente en `length`.
